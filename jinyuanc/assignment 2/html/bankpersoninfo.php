...
//get all of the information form the database
$query = "SELECT BankAccounts.account, BankAccounts.email, BankAccounts.phone, BankAccounts.access_type, BankBSB.BSB, BankBSB.ACC, BankBSB.saving_amount FROM BankAccounts INNER JOIN BankBSB ON BankAccounts.account = BankBSB.name WHERE BankBSB.name = '$session_user'";
    ...
    <div id="all">
        ...
        <div class="content" id="class2">
            <div id="middle" class="middle" style="text-align:center;">
                <h2 style="margin-top:12%">Welcome, <?php echo $session_user; ?></h2>
                <form method="post" action="">
                    <h2>Here are you personal details</h2>
                    <p>Your name: <?php echo $name;?></p>
                    <p>Your eamil: <?php echo $email; ?></p>
                    <p>Phone number: <?php echo $phone;?></p>
                    <p>Bank type: <?php echo $type;?></p>
                    <p>Your BSB: <?php echo $bsb;?></p>
                    <p>Your ACC: <?php echo $acc;?></p>
                    <p>Your saving: <?php echo $saving;?> AUD</p>
                    <p>If your want to know your saving of different currencies,</p>
                    <p>please check your balance in eStatements.</p>
                </form>
            </div>
        </div>
