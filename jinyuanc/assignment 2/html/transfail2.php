    ...
    <div id="all">
        ...
        <div class="content" id="class2">
            <div id="middle" class="middle" style="text-align:center;">
                ...
                <p>Sorry, your transaction is failed.</p>
                <p>The BSB and ACC you want to transfer don't match.</p>
                <p>Please confirm the BSB and ACC you want to transfer</p>
                <p><a href='banktransfer.php'>Back to transfer</a></p>
            </div>
        </div>
