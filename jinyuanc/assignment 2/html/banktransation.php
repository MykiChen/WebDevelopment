...
<body>
    ...
    <div id="all">
        ...
        <div class="content" id="class2">
            <div id="middle" class="middle" style="text-align:center; overflow:auto">
               <form method="post" action="">
                <p>Please choose the function from the following options</p>
                       <p><select name="period">
                       <option value="balance" name="balance">I want to know my balance</option>
                       <option value="today" name="today">I want to know my bank statement(today)</option>
                       <option value="1week" name="1week">I want to know my bank statement(1 week)</option>
                        <option value="1month" name="1month">I want to know my bank statement(1 month)</option>
                        <option value="3month" name="3month">I want to know my bank statement(3 month)</option>
                        <option value="6month" name="6month">I want to know my bank statement(6 month)</option>
                    </select> </p>
