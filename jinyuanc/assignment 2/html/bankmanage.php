    ...
    <div id="all">
        ...
        <div class="content" id="class2">
            <div id="middle" class="middle" style="text-align:center;">
                <h2 style="margin-top:13%">Welcome, <?php echo $session_user; ?></h2>
                <form method="post" action="">
                    <p>Please input the name or BSB or ACC to manage the bank account</p>
                    <p>If you want to add more account, <a href="bankmanage_add.php">click here</a></p>
                    <p>Name <input type="text" name="name"></p>
                    <p>BSB <input type="text" name="bsb"></p>
                    <p>ACC <input type="text" name="acc"></p>
                ...
                if(isset($_POST['submit'])) {
                    ...
                    //if your account is a manager
                    if($type == "manager") {
                        $name = $_POST['name'];
                        $bsb = $_POST['bsb'];
                        $acc = $_POST['acc'];
                        account($name, $bsb, $acc);
                    } else {
                ...
                if(isset($_POST['delete'])) {
                    ...
                    //if the account is a manager, implement the delete code
                    if($type == "manager") {
                        $name = $_POST['name'];
                        $bsb = $_POST['bsb'];
                        $acc = $_POST['acc'];
                        manage_delete($name, $bsb, $acc);
                    } else {
                        //if not a manager, echo error
                        echo "<br><br>Sorry, only manager can manipulate this function.";
                    }
                }
                ?>
