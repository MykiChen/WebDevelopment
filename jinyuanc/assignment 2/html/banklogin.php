...
//get the infomation you log in last time
$query = "SELECT * FROM BankAccess WHERE name LIKE '$session_user' and type = 'login' ORDER BY access_id DESC";
$result = $mysqli->query($query);
if($row = $result->fetch_array(MYSQLI_ASSOC)) {
    $accesstime = $row['AccessTime'];
}

//insert the time of you log in this time
$query = "INSERT INTO BankAccess (name, type) VALUE ('$session_user', 'login')";
$result = $mysqli->query($query);
    ...
    <div id="all">
        ...
        <div class="content" id="class2">
            <div id="middle" class="middle" style="text-align:center;">
                <h2 style="margin-top: 25%">Welcome, <?php echo $session_user; ?></h2>
                <p style="font-size: 20px">The time you accessed our <br>bank system last time is <br><br><?php echo $accesstime; ?> </p>
            </div>
        </div>
